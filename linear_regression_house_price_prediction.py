...
Original file is located at
    https://colab.research.google.com/drive/12eufuUUvPOTkc664AVXyyLxqp_K4RQ-4
...
plt.scatter(house_sizes, prices, color='blue', label='Data Points')              #complete this
plt.xlabel('House Size')                                              #complete this
plt.ylabel('Prices')                                             #complete this
plt.title('House Price against House Size')                                            #complete this
plt.legend()
plt.grid(True)
plt.show()
